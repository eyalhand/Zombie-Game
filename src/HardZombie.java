...
public class HardZombie extends Zombie {
    ...
    private float health = 40, greenValue = 255;

    private BufferedImage zombieImage;

    public HardZombie(float x, float y, ID id, Player player, Handler handler, Block block,int ad) {
        super(x, y, id,ad);
        this.player = player;
    ...
    public void tick() {
        ...
        /*if (block.velY != 0 || block.velX != 0) {
            ...
            health = collision(handler,health,5);
